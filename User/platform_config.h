...
#define	COAPCDPADDR_CHINA_UNICOM_FORMAL	"117.60.157.137"					//联通生产 : "117.60.157.137"		ip753c9d89:5683
...
#define	COAP_NBIOT_BAND_TYPE			COAP_NBIOT_BAND8
#endif
#if NETCARRIERTYPE == NETCARRIERCHINAUNICOM
#define	COAPCDPADDR					COAPCDPADDR_CHINA_UNICOM_TEST
#define	COAPCDPPORT					COAPCDPPORT_CHINA_UNICOM
#define	COAP_NBIOT_BAND_TYPE			COAP_NBIOT_BAND3
#endif
...
#endif
#if NETCARRIERTYPE == NETCARRIERCHINAUNICOM
#define	ONENET_NBIOT_BAND_TYPE			ONENET_NBIOT_BAND3
#endif
...
#if NETCARRIERTYPE == NETCARRIERCHINATELECOM
#define	MQTTSN_NBIOT_BAND_TYPE			MQTTSN_NBIOT_BAND5
#endif
#if NETCARRIERTYPE == NETCARRIERCHINAMOBILE
#define	MQTTSN_NBIOT_BAND_TYPE			MQTTSN_NBIOT_BAND8
#endif
#if NETCARRIERTYPE == NETCARRIERCHINAUNICOM
#define	MQTTSN_NBIOT_BAND_TYPE			MQTTSN_NBIOT_BAND3
#endif
...
#if NETCARRIERTYPE == NETCARRIERCHINATELECOM
#define	DNS_NBIOT_BAND_TYPE				DNS_NBIOT_BAND5
#endif
#if NETCARRIERTYPE == NETCARRIERCHINAMOBILE
#define	DNS_NBIOT_BAND_TYPE				DNS_NBIOT_BAND8
#endif
#if NETCARRIERTYPE == NETCARRIERCHINAUNICOM
#define	DNS_NBIOT_BAND_TYPE				DNS_NBIOT_BAND3
#endif
