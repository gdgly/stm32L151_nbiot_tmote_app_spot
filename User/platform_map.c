...
/**********************************************************************************************************
 @Function			void TCFG_EEPROM_SetUpgradeBaseAddr(unsigned int BaseAddr)
 @Description			TCFG_EEPROM_SetUpgradeBaseAddr				: 保存UpgradeBaseAddr
 @Input				BaseAddr
 @Return				void
**********************************************************************************************************/
void TCFG_EEPROM_SetUpgradeBaseAddr(unsigned int BaseAddr)
{
	FLASH_EEPROM_WriteWord(TCFG_UPGRADE_BASEADDR_OFFSET, BaseAddr);
}

/**********************************************************************************************************
 @Function			unsigned int TCFG_EEPROM_GetUpgradeBaseAddr(void)
 @Description			TCFG_EEPROM_GetUpgradeBaseAddr				: 读取UpgradeBaseAddr
 @Input				void
 @Return				BaseAddr
**********************************************************************************************************/
unsigned int TCFG_EEPROM_GetUpgradeBaseAddr(void)
{
	return FLASH_EEPROM_ReadWord(TCFG_UPGRADE_BASEADDR_OFFSET);
}

/**********************************************************************************************************
 @Function			void TCFG_EEPROM_SetUpgradeBlockNum(unsigned short val)
 @Description			TCFG_EEPROM_SetUpgradeBlockNum				: 保存UpgradeBlockNum
 @Input				val
 @Return				void
**********************************************************************************************************/
void TCFG_EEPROM_SetUpgradeBlockNum(unsigned short val)
{
	FLASH_EEPROM_WriteHalfWord(TCFG_UPGRADE_BLOCKNUM_OFFSET, val);
}

/**********************************************************************************************************
 @Function			unsigned short TCFG_EEPROM_GetUpgradeBlockNum(void)
 @Description			TCFG_EEPROM_GetUpgradeBlockNum				: 读取UpgradeBlockNum
 @Input				void
 @Return				val
**********************************************************************************************************/
unsigned short TCFG_EEPROM_GetUpgradeBlockNum(void)
{
	return FLASH_EEPROM_ReadHalfWord(TCFG_UPGRADE_BLOCKNUM_OFFSET);
}

/**********************************************************************************************************
 @Function			void TCFG_EEPROM_SetUpgradeBlockLen(unsigned short val)
 @Description			TCFG_EEPROM_SetUpgradeBlockLen				: 保存UpgradeBlockLen
 @Input				val
 @Return				void
**********************************************************************************************************/
void TCFG_EEPROM_SetUpgradeBlockLen(unsigned short val)
{
	FLASH_EEPROM_WriteHalfWord(TCFG_UPGRADE_BLOCKLEN_OFFSET, val);
}

/**********************************************************************************************************
 @Function			unsigned short TCFG_EEPROM_GetUpgradeBlockLen(void)
 @Description			TCFG_EEPROM_GetUpgradeBlockLen				: 读取UpgradeBlockLen
 @Input				void
 @Return				val
**********************************************************************************************************/
unsigned short TCFG_EEPROM_GetUpgradeBlockLen(void)
{
	return FLASH_EEPROM_ReadHalfWord(TCFG_UPGRADE_BLOCKLEN_OFFSET);
}

/**********************************************************************************************************
 @Function			void TCFG_EEPROM_SetUpgradeDataLen(unsigned short val)
 @Description			TCFG_EEPROM_SetUpgradeDataLen					: 保存UpgradeDataLen
 @Input				val
 @Return				void
**********************************************************************************************************/
void TCFG_EEPROM_SetUpgradeDataLen(unsigned short val)
{
	FLASH_EEPROM_WriteHalfWord(TCFG_UPGRADE_DATALEN_OFFSET, val);
}

/**********************************************************************************************************
 @Function			unsigned short TCFG_EEPROM_GetUpgradeDataLen(void)
 @Description			TCFG_EEPROM_GetUpgradeDataLen					: 读取UpgradeDataLen
 @Input				void
 @Return				val
**********************************************************************************************************/
unsigned short TCFG_EEPROM_GetUpgradeDataLen(void)
{
	return FLASH_EEPROM_ReadHalfWord(TCFG_UPGRADE_DATALEN_OFFSET);
}
